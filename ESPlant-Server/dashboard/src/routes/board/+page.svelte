<script lang="ts">
	...
	import VrmlViewer from '$lib/components/vrml-viewer.svelte';
	import CaseBottom from '$lib/assets/Case-Bottom.vrml?url';
	import CompartmentDoor from '$lib/assets/Compartment-Door.vrml?url';
...
<header>
	<div class="logo">
		<img src={Logo} alt="ESPlant-Pages Logo" />
		<div>ESPlant</div>
	</div>
	<nav />
</header>
<main>
	...
	<div class="vrml-container">
		<VrmlViewer src="/ESPlant-Board.wrl" />
	</div>
	<h1>ESPlant-Board v2.0 3d case</h1>
	<div class="vrml-container">
		<VrmlViewer src={CaseBottom} />
	</div>
	<h1>ESPlant-Board v2.0 3d compartment door</h1>
	<div class="vrml-container">
		<VrmlViewer src={CompartmentDoor} />
	</div>
	<h1>ESPlant-Board v1.0 Schematic</h1>
	<img src="/ESPlant-Board-schematic.svg" alt="SVG" />
</main>
<footer>
