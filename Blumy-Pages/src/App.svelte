...
<header>
  <div class="logo">
    <img src="/pages/Logo.png" alt="Blumy-Pages Logo" />
    <div>Blumy</div>
  </div>
  <nav />
</header>
<main>
  <h1>Blumy-Board v2.0 3d model</h1>
  <div class="vrml-container">
    <VrmlViewer src="/pages/Blumy-Board/Blumy-Board.wrl"/>
  </div>
  <h1>Blumy-Board v2.0 3d case</h1>
  <div class="vrml-container">
    <VrmlViewer src="/pages/Case-Bottom.vrml"/>
  </div>
  <h1>Blumy-Board v2.0 3d compartment door</h1>
  <div class="vrml-container">
    <VrmlViewer src="/pages/Compartment-Door.vrml"/>
  </div>
  <h1>Blumy-Board v1.0 Schematic</h1>
  <img
    src="/pages/Blumy-Board/Blumy-Board.svg"
    alt="SVG"
  />
</main>
<footer>
  Project on <a href="https://github.com/Dennis960/Blumy">GitHub</a>
</footer>
