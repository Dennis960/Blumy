...
export default class SensorService {
	public static async getRecentReadings(id: number): Promise<SensorReadingDTO[]> {
	...
	public static async getReadings(
		...
		const data = await SensorDataRepository.getAllBySensorIdAveraged(id, startDate, endDate, limit);
	...
	public static fitModel(sensorReadings: SensorReadingDTO[]) {
		...
		const wateringReadings = SensorService.detectWateringReadings(sensorReadings);
