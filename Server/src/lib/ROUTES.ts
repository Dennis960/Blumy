...
const SERVERS = {
  ...
  "GET /api/sensors/[id]/history": (params: { id: (string | number) }) => {
    return `/api/sensors/${params['id']}/history`
  },
...
export type KIT_ROUTES = {
  ...
  SERVERS: { 'POST /api/auth/default/login': never, 'POST /api/auth/default/register': never, 'GET /api/auth/google/callback': never, 'POST /api/auth/google/login': never, 'POST /api/auth/logout': never, 'GET /api/blumyWrl': never, 'POST /api/cron': never, 'DELETE /api/currentAccount': never, 'PUT /api/currentAccount/email': never, 'PUT /api/currentAccount/password': never, 'POST /api/sensorList': never, 'POST /api/sensors': never, 'DELETE /api/sensors/[id]': 'id', 'POST /api/sensors/[id]/check-subscription': 'id', 'GET /api/sensors/[id]/history': 'id', 'GET /api/sensors/[id]/image': 'id', 'POST /api/sensors/[id]/image': 'id', 'PUT /api/sensors/[id]/settings': 'id', 'POST /api/sensors/[id]/subscribe': 'id', 'POST /api/sensors/[id]/unsubscribe': 'id', 'POST /api/sensors/[id]/write-token': 'id', 'POST /api/v2/data': never, 'GET /api/v2/data': never, 'POST /api/waitingList': never }
