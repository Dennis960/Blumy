...
export async function GET(event: RequestEvent): Promise<Response> {
    ...
    try {
        ...
        const existingOauthAccount = (await db.select().from(oauthAccounts).where(and(eq(oauthAccounts.provider, "google"), eq(oauthAccounts.providerUserId, userGoogleId)))).pop();
