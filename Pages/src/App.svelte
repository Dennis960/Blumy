...
<header>
  <div class="logo">
    <img src="/pages/Logo.png" alt="Pages Logo" />
    <div>Blumy</div>
  </div>
  <nav />
</header>
<main>
  <h1>Board v2.0 3d model</h1>
  <div class="vrml-container">
    <VrmlViewer src="/pages/Board/Board.wrl"/>
  </div>
  <h1>Board v2.0 3d case</h1>
  <div class="vrml-container">
    <VrmlViewer src="/pages/Case-Bottom.vrml"/>
  </div>
  <h1>Board v2.0 3d compartment door</h1>
  <div class="vrml-container">
    <VrmlViewer src="/pages/Compartment-Door.vrml"/>
  </div>
  <h1>Board v1.0 Schematic</h1>
  <img
    src="/pages/Board/Board.svg"
    alt="SVG"
  />
</main>
<footer>
