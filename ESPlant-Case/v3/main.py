...
pcb_tolerance = Vector(1.5, 1.5, 0.5) # having different tolerances for x and y is not supported
part_tolerance = 1
...
part_list.apply_pcb_tolerance(pcb_tolerance, should_use_fixation_holes, fixation_hole_diameter, hole_fit_tolerance)
