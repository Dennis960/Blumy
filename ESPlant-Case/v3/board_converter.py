...
class BoardConverter:
    def __init__(self, cache_dir="parts/"):
        ...
        self.unique_board_name = "__B$O$A$R$D__"
    ...
    def _override_unique_board_name(self, unique_board_name: str):
        """
        TODO: This is a workaround
        Overrides the unique board name.
        This is an internal function that will be replaced by a better solution in the future.
        """
        self.unique_board_name = unique_board_name
        return self
    ...
    def from_step_file(self, step_path: str) -> dict[str, TopoDS_Shape]:
        ...
        if freeShapes.Length() != 1:
            ...
            exit()
        shapes[self.unique_board_name] = shapeTool.GetShape_s(
            freeShapes.Value(1))
...
if __name__ == "__main__":
    ...
    (BoardConverter()
     ._override_unique_board_name("A)$CUTC)ZE)FACFZE")
